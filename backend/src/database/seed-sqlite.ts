...
// Major hospitals across Quebec regions
const hospitals = [
  ...
  { nameFr: 'Hôtel-Dieu de Lévis', nameEn: 'Lévis Hotel-Dieu', regionCode: '12', type: 'Regional', city: 'Lévis', lat: 46.8037, lng: -71.1713, beds: 305, hasEmergency: 1, hasICU: 1, hasLab: 1 },
  { nameFr: 'Hôpital de Montmagny', nameEn: 'Montmagny Hospital', regionCode: '12', type: 'Community', city: 'Montmagny', lat: 46.9809, lng: -70.5552, beds: 92, hasEmergency: 1, hasICU: 0, hasLab: 1 },

  // Region 13 - Laval
  { nameFr: 'Cité-de-la-Santé', nameEn: 'Cité-de-la-Santé', regionCode: '13', type: 'Regional', city: 'Laval', lat: 45.5597, lng: -73.7321, beds: 543, hasEmergency: 1, hasICU: 1, hasLab: 1 },
  { nameFr: 'Hôpital juif de réadaptation', nameEn: 'Jewish Rehabilitation Hospital', regionCode: '13', type: 'Specialized', city: 'Laval', lat: 45.5417, lng: -73.7537, beds: 175, hasEmergency: 0, hasICU: 0, hasLab: 1 },

  // Region 14 - Lanaudière
  { nameFr: 'Centre hospitalier Pierre-Le Gardeur', nameEn: 'Pierre-Le Gardeur Hospital', regionCode: '14', type: 'Regional', city: 'Terrebonne', lat: 45.7097, lng: -73.6322, beds: 372, hasEmergency: 1, hasICU: 1, hasLab: 1 },
  { nameFr: 'Centre hospitalier de Joliette', nameEn: 'Joliette Hospital', regionCode: '14', type: 'Regional', city: 'Joliette', lat: 46.0218, lng: -73.4459, beds: 253, hasEmergency: 1, hasICU: 0, hasLab: 1 },

  // Region 15 - Laurentides
  { nameFr: 'Hôpital de Saint-Eustache', nameEn: 'Saint-Eustache Hospital', regionCode: '15', type: 'Regional', city: 'Saint-Eustache', lat: 45.5638, lng: -73.9072, beds: 311, hasEmergency: 1, hasICU: 1, hasLab: 1 },
  { nameFr: 'Hôpital de Saint-Jérôme', nameEn: 'Saint-Jérôme Hospital', regionCode: '15', type: 'Regional', city: 'Saint-Jérôme', lat: 45.7790, lng: -74.0027, beds: 443, hasEmergency: 1, hasICU: 1, hasLab: 1 },

  // Region 16 - Montérégie
  { nameFr: 'Hôpital Charles-Le Moyne', nameEn: 'Charles-Le Moyne Hospital', regionCode: '16', type: 'University', city: 'Longueuil', lat: 45.5174, lng: -73.4682, beds: 589, hasEmergency: 1, hasICU: 1, hasLab: 1 },
  { nameFr: 'Hôpital Pierre-Boucher', nameEn: 'Pierre-Boucher Hospital', regionCode: '16', type: 'Regional', city: 'Longueuil', lat: 45.5395, lng: -73.4482, beds: 378, hasEmergency: 1, hasICU: 0, hasLab: 1 },
  { nameFr: 'Hôpital du Haut-Richelieu', nameEn: 'Haut-Richelieu Hospital', regionCode: '16', type: 'Regional', city: 'Saint-Jean-sur-Richelieu', lat: 45.3176, lng: -73.2649, beds: 264, hasEmergency: 1, hasICU: 1, hasLab: 1 },

  // Region 17 - Nunavik
  { nameFr: 'Centre de santé Inuulitsivik', nameEn: 'Inuulitsivik Health Centre', regionCode: '17', type: 'Community', city: 'Puvirnituq', lat: 60.0389, lng: -77.2834, beds: 12, hasEmergency: 1, hasICU: 0, hasLab: 1 },
];
